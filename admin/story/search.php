                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    ...
                                    if (isset($_GET['search']) && !empty($_GET['search'])) {
                                        ...
                                        $sql = "SELECT story.*,cat.name as cat_name FROM story INNER JOIN cat ON story.cat_id = cat.cat_id WHERE story.name LIKE '%$key%' LIMIT $offset, $limit_item";
                                    } else {
                                        $sql = "SELECT story.*,cat.name as cat_name FROM story INNER JOIN cat ON story.cat_id = cat.cat_id LIMIT $offset, $limit_item";
                                    }
